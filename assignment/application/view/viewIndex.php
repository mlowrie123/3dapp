          ...
          <div class="col-sm-10">
              <div class="card text-left">
                  ...
                  <div id="lights" style="display:none;" class="card-body">
                    ...
                    <a href="#" class="btn btn-success btn-responsive camera-font" onclick="headLight();"> On</a>
                    <a href="#"class="btn btn-danger btn-responsive camera-font" onclick="headLight();"> Off</a>
                    <div class="card-text x3dCameraDescription drinksText">
                      <p>These buttons animate the model, use the dropdown menu for more other options. Please note, the light only works on the coke can. For the best effect, turn the can left first...</p>
                    </div>
                  </div>
                  ...
                  <div id="Model" style="display:none;" class="card-body">
                    ...
                    <a href="#" class="btn btn-success btn-responsive camera-font" onclick="wireframe3()"> Normal</a>
                    <a href="#" class="btn btn-danger btn-responsive camera-font" onclick="wireframe();"> Wireframe</a>
                    <a href="#" class="btn btn-primary btn-responsive camera-font" onclick="wireframe();"> More Wires</a>
                    <div class="card-text x3dCameraDescription drinksText">
                      <p>These buttons animate the model, use the dropdown menu for more other options. Please note wireframe only works on the sprite bottle.</p>
                    </div>
                  </div>
...
<nav id="footerColor"  class="navbar navbar-expand-sm footer fixed-bottom">
    <div class = "container">
            <div class = "navbar-text float-left copyright">
              <p><span class="align-baseline">&copy Max Lowrie | Cand No:215698 | Click  github logo for code  </span></p>
        </div>
        <div class = "navbar-text float-right social">
          ...
          <a href="https://github.com/mlowrie123/3dapp.git"> <i class= "fab fa-github-square fa-2x" style="font-size:20px;color:rgb(128, 0, 21);"></i></a>
        </div>
    </div>
</nav>
